...
window.CS.schema2026 = {
  ...
  seasonYear: 2026,
  gameName: "Rebuilt",
  // Drives expected-points (CS-EPA) math in lib/analysis.js.
  // pointsPer = numeric fields, points = booleans, pointsMap = selects.
  pointsModel: {
    auto: [
      { field: "auto_fuel_scored", pointsPer: 1 },
      { field: "auto_left_zone", points: 3 },
      { field: "auto_climbed_level1", points: 10 },
    ],
    teleop: [
      { field: "teleop_fuel_scored", pointsPer: 1 },
    ],
    endgame: [
      { field: "endgame_climb_level", pointsMap: { none: 0, attempted_failed: 0, level1: 10, level2: 20, level3: 30 } },
    ],
  },
  sections: [
    // ── AUTO ──────────────────────────────────────────────────────────────────
